...
const loadData = (data) => {
  ...
  dataRecords.forEach((record, index) => {
    ...
    incrRecord_i0 = incrRecord_temp[0] > 0 ? '+' + intToString(incrRecord_temp[0]) : '';
    incrRecord_i1 = incrRecord_temp[1] > 0 ? '+' + intToString(incrRecord_temp[1]) : '';
    incrRecord_i2 = incrRecord_temp[2] > 0 ? '+' + intToString(incrRecord_temp[2]) : '';
    incrRecord_i3 = incrRecord_temp[3] > 0 ? `+${incrRecord_temp[3]} mins.` : '';
    incrRecord_i4 = incrRecord_temp[4] > 0 ? `+${incrRecord_temp[4]} secs.` : '';
